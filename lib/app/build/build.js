...
/***/ function(module, exports, __webpack_require__) {
	...
	var InstalledModules = __webpack_require__(4);
	var SearchModules = __webpack_require__(5);

	var App = React.createClass({displayName: 'App',
	    render: function () {
	        return (
	            React.DOM.div({className: "plugin-manager"}, 
	                React.DOM.header(null, React.DOM.h3(null, "Installable Plugin Manager")), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var InstalledModule = __webpack_require__(10);

	var InstalledModules = React.createClass({displayName: 'InstalledModules',
	    render: function () {
	        ...
	        if (rows.length) {
	            return (
	                React.DOM.section({className: "installed-modules"}, rows)
	            );
	        } else {
	            return (
	                React.DOM.section({className: "installed-modules"}, 
	                    React.DOM.p(null, "No plugins are installed")
	                )
	            );
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var SearchResult = __webpack_require__(11);

	var SearchModules = React.createClass({displayName: 'SearchModules',
	    ...
	    render: function () {
	        ...
	        if (rows.length) {
	            return (
	                React.DOM.section({className: "search"}, 
	                    React.DOM.input({type: "text", placeholder: "Search", onKeyDown: this.onKeyDown}), 
	                    rows
	                )
	            );
	        } else {
	            return (
	                React.DOM.section({className: "search"}, 
	                    React.DOM.input({type: "text", placeholder: "Search", onKeyDown: this.onKeyDown}), 
	                    React.DOM.p(null, "No plugins found.")
	                )
	            );
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(94), __webpack_require__(97), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/niko/Code/installable/lib/app/node_modules/css-loader/index.js!/Users/niko/Code/installable/lib/app/node_modules/autoprefixer-loader/index.js!/Users/niko/Code/installable/lib/app/src/app.css", function() {
			var newContent = require("!!/Users/niko/Code/installable/lib/app/node_modules/css-loader/index.js!/Users/niko/Code/installable/lib/app/node_modules/autoprefixer-loader/index.js!/Users/niko/Code/installable/lib/app/src/app.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "html {\n  -moz-box-sizing: border-box;\n       box-sizing: border-box;\n}\n*, *:before, *:after {\n  -moz-box-sizing: inherit;\n       box-sizing: inherit;\n  font-family: 'Open Sans', sans-serif;\n  color: rgb(160, 160, 160);\n}\n\nbutton {\n    float: right;\n}\n\ninput {\n    width: 100%;\n    min-height: 30px;\n    font-size: 14px;\n    border: 1px solid #dadada;\n    border-radius: 3px;\n    padding: 4px;\n    outline: none;\n}\n\n\n.plugin-manager {\n    position: relative;\n    margin: 10% auto;\n    max-width: 400px;\n    background-color: #fafafa;\n    padding: 20px;\n    border: 1px solid #dadada;\n    border-radius: 3px;\n    box-shadow: 2px 2px 60px rgba(200,200,200,0.6);\n}\n\n    .plugin-manager header {\n        position: absolute;\n        left: 0;\n        top: 0;\n        width: 100%;\n        background: -webkit-linear-gradient(top, rgba(240,240,240,0.65) 0%, rgba(94,94,94,0.40) 100%);\n        background: linear-gradient(to bottom, rgba(240,240,240,0.65) 0%, rgba(94,94,94,0.40) 100%);\n        border-bottom: 1px solid #dadada;\n    }\n\n        .plugin-manager header h3 {\n            text-align: center;\n            font-size: 16px;\n            color: rgb(126, 126, 126);\n        }\n\n\n.installed-modules {\n    margin-top: 60px;\n}\n\n\n.search {\n    margin-top: 80px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InstalledModule = React.createClass({displayName: 'InstalledModule',
	    ...
	    render: function () {
	        return (
	            React.DOM.div({className: "installed-module"}, 
	                this.props.module.get('name'), 
	                React.DOM.button({onClick: this.onClickUninstall}, "Uninstall")
	            )
	        );
	    }
	});
	    ...
	    render: function () {
	        return (
	            React.DOM.div({className: "search-result"}, 
	                this.props.module.get('name'), 
	                React.DOM.button({onClick: this.onClickInstall}, "Install")
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeInto = __webpack_require__(85);
	var mapObject = __webpack_require__(56);
